      ...
      <div>
        <ul className="filter">
          ...
          <li className="filter_item">
            ...
            <label htmlFor="filter1" className="filter_label">
              <span>여자</span>
            </label>
          </li>
          <li className="filter_item">
            <input type="checkbox" id="filter2" />
            <label htmlFor="filter2" className="filter_label">
        ...
        <div className="character_item">
          <dl>
            <div className="unit_info">
              ...
              <dd className="content">홍길동</dd>
            </div>
            <div className="unit_info">
              <dt className="title">aliases</dt>
              <dd className="content">소설주인공, 도둑, 열혈청년</dd>
            </div>
            <div className="unit_info">
              <dt className="title">title</dt>
              <dd className="content">신홍길동전, 도둑들</dd>
            </div>
            <div className="unit_info">
              <dt className="title">books</dt>
              <dd className="content">3</dd>
            </div>
            <div className="unit_info">
              <dt className="title">tvSeries</dt>
              <dd className="content">1</dd>
            </div>
          </dl>
